...
//            new Color []{ Color.RED, Color.ORANGE, Color.YELLOW, Color.GREEN, Color.cyan, Color.blue, VIOLET });
        ...
        LinearGradientPaint basePizzaPaint = new LinearGradientPaint(0, JBUI.scale(2), 0, h - JBUI.scale(6),
            new float[]{
                ONE_OVER_THREE * 1,
                ONE_OVER_THREE * 2,
                ONE_OVER_THREE * 3,
            },
            new Color[]{new Color(0xA80000), Color.WHITE, new Color(0x008800)}
        );

        g.setPaint(basePizzaPaint);
...
//        g.setPaint(baseRainbowPaint);
        ...
        Icon scaledIcon = velocity > 0 ? ((ScalableIcon) NyanIcons.Pizza) : ((ScalableIcon) NyanIcons.PizzaFlip) ;
//        if (velocity < 0) {
...
//            new Color []{ Color.RED, Color.ORANGE, Color.YELLOW, Color.GREEN, Color.cyan, Color.blue, VIOLET }));
        ...
        NyanIcons.Pizza.paintIcon(progressBar, g2, amountFull - JBUI.scale(10), -JBUI.scale(6));
